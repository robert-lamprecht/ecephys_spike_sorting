...
class EphysParams(DefaultSchema):
    ...
    num_channels = Int(required=True, default=385, help='Total number of channels in binary data files')
    num_sync_channels = Int(required=True, default=1, help='Number of sync channels in binary data files')
